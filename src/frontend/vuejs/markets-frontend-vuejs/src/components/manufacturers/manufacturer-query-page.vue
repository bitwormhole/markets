...
import MyLoader from './manufacturer-table-page-loader.vue'
import MyTable from './manufacturer-table-view.vue'
...
export default {
  ...
  methods: {
    ...
    handleClickAdd() {
      let path = '/admin/manufacturers/add'
