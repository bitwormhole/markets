...
import MyKeepTokenAlive from './session-keep-token-alive.vue'
...
export default {
  ...
  components: { MiniLoginDialog, ElButton, MyKeepTokenAlive },
...
<template>
  <div>
    ...
    <div v-show="theIsAuth">
      <MyKeepTokenAlive> </MyKeepTokenAlive>
      ...
      >
        ...
        <template #default>
          <div class="demo-rich-conent" style="display: flex; gap: 16px; flex-direction: column">
            ...
            <ElButton @click="handleClickSettings"> 设置 </ElButton>
